  ...
  return (
    <div className="policy-page">
      <div className="policy-content">
        ...
        <p>
          Attualmente non utilizziamo cookie di terze parti sul nostro sito. Per
          maggiori informazioni sui cookie che utilizziamo, consulta la sezione
          &quot;Tipi di Cookie che Utilizziamo&quot; sopra.
        </p>
