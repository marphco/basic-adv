          ...
          <tr>
            ...
            <th onClick={() => handleSort("brandName")}>
              ...
              <span className="sort-icons">
                ...
                <FontAwesomeIcon
                  icon={faSortDown}
                  className={`sort-icon ${
                    sortField === "brandName" && sortDirection === "desc"
                      ? "active"
                      : ""
                  }`}
                />
            ...
            {selectedSection === "all" ? (
              <>
                ...
                <th className="centered" onClick={() => handleSort("lang")}>
              Lingua
            </th>
            ...
            return (
              ...
              >
                ...
                {selectedSection === "all" ? (
                  ...
                  <span
                    className={`lang-flag ${
                      req.formData?.lang === "en" ? "en" : "it"
                    }`}
                    title={req.formData?.lang === "en" ? "English" : "Italiano"}
                  >
                    {req.formData?.lang === "en" ? "🇺🇸" : "🇮🇹"}
                  </span>
                </td>
                    <td className="centered">
                      <span
